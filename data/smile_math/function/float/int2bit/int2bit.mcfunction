...
execute if score #int2bit.bit sml matches 0 run data modify storage float: bit_integer prepend value 0
execute if score #int2bit.bit sml matches 1 run data modify storage float: bit_integer prepend value 1
