...
execute store result score #float.sign sml run function smile_math:float/parse/get_sign
...
execute if score #float.sign sml matches 1 store result score #float.integer sml run function smile_math:float/parse/integer/n2p_int_part

execute store result storage float: integer int 1.0 run scoreboard players get #float.integer sml

execute store result score #float.dec_start sml run function smile_math:float/parse/integer/get_int_len
...
execute store result score #float.is_integer sml run function smile_math:float/parse/is_integer

function smile_math:float/parse/integer/int2bit

execute if score #float.is_integer sml matches 0 store result score #float.decimal sml run function smile_math:float/parse/decimal/dec2score/get_score_fm_str_dec
execute if score #float.is_integer sml matches 1 run scoreboard players set #float.decimal sml 0

execute if score #float.integer sml matches 1.. run function smile_math:float/parse/decimal/dec2bit
execute if score #float.integer sml matches 0 run function smile_math:float/parse/decimal/small_dec2bit
