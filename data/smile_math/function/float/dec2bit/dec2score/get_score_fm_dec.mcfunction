...
execute if score #dec2bit.digit_index sml matches 9 if function smile_math:float/dec2bit/dec2score/reset run return run scoreboard players get #dec2score.result sml
