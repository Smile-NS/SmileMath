...
$execute store result storage float: split_decimal[$(start)] int 1.0 run function smile_math:float/dec2bit/get_digit_fm_char
...
function smile_math:float/dec2bit/split with storage float: split
