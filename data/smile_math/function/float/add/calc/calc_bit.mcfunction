...
$execute store result score #calc.x_bit sml run data get storage float: add.x.fraction[$(current_index)] 1.0 
$execute store result score #calc.y_bit sml run data get storage float: add.y.fraction[$(current_index)] 1.0 
...
execute unless score #calc.result_bit sml matches 2.. run data modify storage float: add.output.tmp.bit set value 0
execute if score #calc.result_bit sml matches 2.. run data modify storage float: add.output.tmp.bit set value 1
...
execute store result storage float: add.output.tmp.current_index int 1.0 run scoreboard players get #calc.current_index sml
function smile_math:float/add/calc/set_bit with storage float: add.output.tmp

function smile_math:float/add/calc/calc_bit with storage float: add.output.tmp